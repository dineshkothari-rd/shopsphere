    ...
    <>
      ...
      <section className="pb-20">
        <Container className="space-y-24">
          ...
          <div className="space-y-10">
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Discover premium collections curated for modern shoppers.
              </p>
            </div>
          ...
          {/* promo banner */}
          <div className="glass premium-shadow overflow-hidden rounded-[3rem] border border-white/10">
            <div className="grid items-center gap-10 p-8 lg:grid-cols-2 lg:p-14">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground">
                  Elevate your lifestyle with curated products and exclusive
                  discounts.
                </p>
          ...
          <div className="space-y-10">
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Designed for seamless and premium ecommerce experiences.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                {
                  title: "Fast Delivery",
                  desc: "Realtime order tracking and premium delivery experience.",
                },

                {
                  title: "Secure Payments",
                  desc: "Safe and reliable transactions for modern shoppers.",
                },

                {
                  title: "Premium Quality",
                  desc: "Curated products with high-quality standards.",
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="glass premium-shadow rounded-[2rem] border border-white/10 p-8"
                >
